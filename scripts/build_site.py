...
.about-image-badge strong{display:block;font-size:0.95rem}
...
.feature-card{background:#fff;border:1px solid var(--border);border-radius:var(--radius);padding:30px 24px;text-align:center;transition:all var(--transition)}
.feature-card:hover{transform:translateY(-4px);box-shadow:var(--shadow-md);border-color:rgba(0,102,164,0.30)}
.feature-icon{width:64px;height:64px;border-radius:18px;background:var(--primary-light);color:var(--primary);display:flex;align-items:center;justify-content:center;font-size:1.5rem;margin:0 auto 14px}
...
.gallery-preview-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px}
.gallery-preview-grid img{width:100%;height:200px;object-fit:cover;border-radius:var(--radius);transition:transform 0.5s ease}
.gallery-preview-grid img:hover{transform:scale(1.04)}

@media (max-width:1024px){
  .hero-grid,.about-grid,.cta-banner-inner{grid-template-columns:1fr;gap:30px}
...
<section class="hero-clean" id="home">
  ...
  <div class="hero-bg-slides" id="heroBgSlides">
    ...
    <div class="hero-bg-slide" style="background-image: url('images/hero/slide-3.jpg')"></div>
...
<div class="hero-quick-bar-wrap">
  <div class="container">
    <div class="hero-quick-bar">
      ...
      <a href="doctors.html" class="quick-bar-item">
      ...
      <a href="diagnostic.html" class="quick-bar-item">
  ...
  <div class="container">
    <div class="about-grid">
      ...
      <div class="about-content">
        ...
        <p><strong>নিরাময় হাসপাতাল এন্ড ডায়াগনস্টিক সেন্টার (প্রা:)</strong> — ১৯৯৯ সাল থেকে ফরিদপুরের নিরাময় ভবন, পশ্চিম খাবাসপুরে স্বনামধন্য স্বয়ংসম্পূর্ণ বেসরকারি হাসপাতাল।</p>
        <p>প্রতিষ্ঠাতা মোহাম্মদ কুব্বাত বিশ্বাস-এর ঐকান্তিক প্রচেষ্টায় গড়ে ওঠা এই প্রতিষ্ঠানে ১৪+ বিশেষজ্ঞ চিকিৎসক নিয়মিত সেবা দিচ্ছেন।</p>
        <ul class="about-features">
          <li><i class="fa-solid fa-check-circle"></i> ১৪+ বিশেষজ্ঞ চিকিৎসক সব বিভাগে</li>
          <li><i class="fa-solid fa-check-circle"></i> ২৪/৭ ইমার্জেন্সি ও অ্যাম্বুলেন্স</li>
        ...
        <div class="about-cta">
          <a href="about.html" class="btn btn-primary"><i class="fa-solid fa-circle-info"></i> বিস্তারিত জানুন</a>
...
<section class="section section-soft">
  <div class="container">
    <div class="section-head">
      <span class="section-eyebrow">কেন আমরাই</span>
      <h2 class="section-title">কেন <span class="gradient-text">নিরাময় বেছে নেবেন</span></h2>
      <p class="section-subtitle">আমাদের সেবার মূল বৈশিষ্ট্য যা আমাদের আলাদা করে</p>
    </div>
    <div class="features-grid">
      <div class="feature-card reveal">
        <div class="feature-icon"><i class="fa-solid fa-user-doctor"></i></div>
        <h3>অভিজ্ঞ বিশেষজ্ঞ</h3>
        <p>বঙ্গবন্ধু শেখ মুজিব মেডিকেল কলেজ ও ঢাকার স্বনামধন্য প্রতিষ্ঠানের ১৪+ বিশেষজ্ঞ</p>
      </div>
      <div class="feature-card reveal">
        <div class="feature-icon"><i class="fa-solid fa-clock"></i></div>
        <h3>২৪/৭ ইমার্জেন্সি</h3>
        <p>সার্বক্ষণিক ইমার্জেন্সি ও অ্যাম্বুলেন্স সেবা, যেকোনো সময় কল করুন</p>
      </div>
      <div class="feature-card reveal">
        <div class="feature-icon"><i class="fa-solid fa-microscope"></i></div>
        <h3>আধুনিক ডায়াগনস্টিক</h3>
        <p>সর্বাধুনিক যন্ত্রপাতি দিয়ে সঠিক ও দ্রুত রিপোর্ট</p>
      </div>
      <div class="feature-card reveal">
        <div class="feature-icon"><i class="fa-solid fa-bangladeshi-taka-sign"></i></div>
        <h3>সাশ্রয়ী মূল্য</h3>
        <p>সবার আওতায় মানসম্মত স্বাস্থ্যসেবা — সাশ্রয়ী মূল্যে</p>
      </div>
    </div>
  </div>
</section>
...
<section class="stats-section">
  <div class="container">
    <div class="stats-grid">
      <div class="stat-item"><div class="n">১৪+</div><p>বিশেষজ্ঞ ডাক্তার</p></div>
      <div class="stat-item"><div class="n">২৫+</div><p>বছরের অভিজ্ঞতা</p></div>
      <div class="stat-item"><div class="n">১,০০,০০০+</div><p>সেবা প্রাপ্ত রোগী</p></div>
      <div class="stat-item"><div class="n">২৪/৭</div><p>ইমার্জেন্সি সেবা</p></div>
    </div>
  </div>
</section>
    ...
    <div class="cta-banner-inner">
      <div>
        ...
        <div class="cta-actions">
          <a href="appointment.html" class="btn btn-accent"><i class="fa-regular fa-calendar-check"></i> এখনই অ্যাপয়েন্টমেন্ট নিন</a>
...
<section class="section section-soft">
  <div class="container">
    ...
    <div class="gallery-preview-grid">
      <img src="niramoy-aidfast-cover.jpg" alt="হাসপাতাল ভবন" loading="lazy" />
      <img src="niramaya-banner-official.jpg" alt="NIRAMAYA Official Banner" loading="lazy" />
      <img src="niramoy-building-night.jpg" alt="সন্ধ্যার আলোয়" loading="lazy" />
      <img src="niramoy-archhms-header.jpg" alt="ভেতরের অংশ" loading="lazy" />
    </div>
    <div class="view-all-wrap">
      <a href="gallery.html" class="btn btn-outline"><i class="fa-solid fa-images"></i> সব ছবি দেখুন</a>
    </div>
  </div>
</section>
'''
